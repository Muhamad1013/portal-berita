<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}"
        ...
        <div style="display: flex; align-items: center; justify-content: flex-end; margin-top: 1.5rem;">
            <a href="{{ route('login') }}" style="font-size: 0.875rem; color: #374151; text-decoration: none;"
            ...
            <button type="submit"
                style="margin-left: 1rem; padding: 0.5rem 1.5rem; background-color: #dc2626; color: white; border-radius: 0.375rem; border: none; cursor: pointer; font-size: 0.875rem; font-weight: 500;"

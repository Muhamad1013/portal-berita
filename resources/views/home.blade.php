  ...
  <div class="container py-5">
    ...
    @endif
      ...
      <div id="carouselGlobalNews" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="col-md-4 col-12 mb-3">
        <div class="card h-100 border-0 card-hover">
        <a href="{{ $article['link'] }}" class="text-decoration-none text-dark" target="_blank">
        <img src="{{ $article['image_url'] }}" class="card-img-top" alt="Gambar Berita">
        <div class="card-body px-0 pt-2 pb-0">
        <h6 style="font-weight: bold" class="card-title mb-0">{{ $article['title'] }}</h6>
        <div class="card-date small text-muted mt-2">
      ...
      @endforeach
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#carouselGlobalNews" data-bs-slide="prev">
        <span class="carousel-control-prev-icon"><i class="fas fa-chevron-left"></i></span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#carouselGlobalNews" data-bs-slide="next">
        <span class="carousel-control-next-icon"><i class="fas fa-chevron-right"></i></span>
        </button>
      </div>
    @endif
    ...
    <div class="col-md-4 sidebar ps-md-4 mt-5 mt-md-0">
      ...
      <h6>{{ $recent['title'] }}</h6>
      <small class="text-muted">{{ \Carbon\Carbon::parse($recent['pubDate'])->translatedFormat('d F Y') }}</small>
      </div>
      </a>
    @endforeach
      </div>

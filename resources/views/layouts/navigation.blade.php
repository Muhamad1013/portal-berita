<nav x-data="{ open: false }" class="bg-[#f8f9fa] border-b border-gray-300 text-[#1c1c1e] font-[Inter,sans-serif]">
        ...
        <div class="flex items-center gap-4 justify-between h-16">
            ...
            <div class="flex-shrink-0">
                @auth
                    ...
                    @endphp
                    <a href="{{ $redirect }}" class="text-xl font-bold font-[Georgia,serif]" style="font-weight:bold; color:#1c1c1e;" onmouseover="this.style.color='#dc2626';" onmouseout="this.style.color='#1c1c1e';">FastNews</a>
                @else
                    <a href="{{ route('home') }}" class="text-xl font-bold font-[Georgia,serif]" style="color:#1c1c1e;" onmouseover="this.style.color='#dc2626';" onmouseout="this.style.color='#1c1c1e';">FastNews</a>
                @endauth
            </div>
            ...
            <div class="flex items-center text-sm">
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 text-sm"
                                style="color:#1c1c1e;" onmouseover="this.style.color='#dc2626';" onmouseout="this.style.color='#1c1c1e';">
                                {{ Auth::user()->name }}
                ...
                @else
                    <a href="{{ route('login') }}" style="color:#4b5563; transition:color 0.2s;" onmouseover="this.style.color='#dc2626';" onmouseout="this.style.color='#4b5563';">Login</a>
                    <a href="{{ route('register') }}" style="color:#dc2626; margin-left:1rem; text-decoration:none;" onmouseover="this.style.textDecoration='underline';" onmouseout="this.style.textDecoration='none';">Daftar</a>
                @endauth
            </div>
        </div>
    </div>
...
<!-- Bar Kategori -->
<nav class="border-b border-red" style="background-color: #dc2626;">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto flex gap-2 py-2 text-sm font-medium overflow-x-auto">
            @foreach(['Nasional', 'Ekonomi', 'Teknologi', 'Hiburan', 'Olahraga', 'Global'] as $kategori)
